...
fire_and_safety theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of fire_and_safety theme and run the following commands:
`nvm use`
...
`drush en fire_and_safety -y`
`drush config-set system.theme default fire_and_safety -y`
